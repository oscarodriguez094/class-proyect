...
export const GET_QUESTIONID = 'GET_QUESTIONID'
export const GET_QUESTIONID_SUCCES = 'GET_QUESTIONID_SUCCES'
export const GET_QUESTIONID_ERROR = 'GET_QUESTIONID_ERROR'

export const GET_USER_ANSWER = 'GET_USER';
export const GET_USER_ANSWER_SUCCESS = 'GET_USER_ANSWER_SUCCESS';
export const GET_USER_ANSWER_ERROR = 'GET_USER_ANSWER_ERROR';

export const DELETE_ANSWERS_BY_QUESTION = 'DELETE_ANSWERS_BY_QUESTION';
export const DELETE_QUESTION_BY_PATH = 'DELETE_QUESTIONS_BY_PATH';
